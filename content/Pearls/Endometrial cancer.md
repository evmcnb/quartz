...
The number one presenting symptom of endometrial cancer to remember is **_postmenopausal bleeding_**.
...
> Immediate referral for anyone with postmenopausal bleeding. 
...
Depending on local guidelines, a normal **_transvaginal ultrasound_** (endometrial thickness < 4mm) and normal **_pipelle biopsy_** are sufficient to demonstrate a very low risk of endometrial cancer and discharge the patient.

## Management

The usual treatment for stage 1 and 2 endometrial cancer is a **_total abdominal hysterectomy with bilateral salpingo-oophorectomy_**, also known as a **_TAH and BSO_** (removal of uterus, cervix and adnexa).
...
- Radiotherapy
- Chemotherapy
- **_Progesterone_** may be used as a hormonal treatment to slow the progression of the cancer
