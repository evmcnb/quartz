...
date modified: Sunday, January 4th 2026, 3:31:13 pm
...
Investigated with:
- Pelvic USS
- FSH, LH, prolactin (normal/high), TSH, testosterone (normal/slightly elevated, should not be really high), SHBG (normal/low)
- CBG/check for impaired glucose tolerance

* $\uparrow$ GnRH $\rightarrow$ $\uparrow$ LH $\downarrow$ FSH $\rightarrow$ hyperandrogenism (raised testosterone) $\rightarrow$ $\downarrow$ sex hormone binding globulin (SHBG)
