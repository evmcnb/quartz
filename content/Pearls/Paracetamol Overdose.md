...
[[Pearls/Paracetamol|Paracetamol]] is absorbed from the gut and rapidly metabolised by the liver. A toxic metabolite is produced and glutathione is required to continue the metabolism to a safe product. Glutathione has a finite supply - if depleted the metabolite causes an acute liver injury. 4g of [[Pearls/Paracetamol|Paracetamol]] is the maximum dose in a day
...
**8-24 hours:**Calculateweight and start N-acetylcysteine if ingestion is > 150 mg/kg (or if [[Pearls/Paracetamol|Paracetamol]] concentration is not available).
