...
If any neurological features are present then spinal cord compression must be suspected and acted on promptly. Without neurological features, a whole spine MRI should be completed within one week. The whole spine should be imaged as patients commonly present with multi-level disease.
...
- Neurological signs depend on the level of the lesion.
	- Above L1 - UMN signs because of compression of CST
	- Below L1 - LMN signs because of spinal nerve root compression (more like [[Pearls/Cauda equina syndrome]])
