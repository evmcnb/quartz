...
1. degree: no prolapse
2. degree: prolapse when straining and return in relaxing
3. degree: prolapse when straining do not return on relaxing but can be pushed back
4. degree: prolapsed permanently
...
* [[Pearls/Paracetamol|Paracetamol]] can be prescribed for pain - opioids (can cause constipation) and NSAIDs (if rectal bleeding) should be avoided
