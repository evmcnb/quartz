...
- MRI
- Liver biopsy
- Ascitic tap - to rule out SBP (hard to determine otherwise) - neutrophils > 250
...
- Immediately discontinue BB and diuretics
- Treat with terlipressin (norepinephrine in ICU) + albumin
- Discontinue ACE/ARB
- Extremely high mortality when MAP drops below 82.

Hepatopulmonary syndrome: 
- Orthodeoxia + platypnea (SOB and hypoxia when sitting up, relived when lying down). This is due to dilations at the base of the lines forming a shunt with no gas exchange
- Associated with increased number of spider nevi/angiomata
- Echo with contrast/bubble to check for intrapulmonary shunt (3-8 cardiac cycles)
- Liver transplant is definitive treatment 

Hyponatremia
- Due to increased release of ADH (kidneys feel hypoperfused)
