...
- **Chunk and Check:** Give a little bit of information, then stop. Ask, "Does that make sense?" or "How does that sound to you?" Do not deliver a 4-minute monologue.
- **Safety Netting:** This is the most critical part of an acute station. Be specific. Don't just say "come back if they get worse." Say, "If they have fewer than 3 wet nappies in 24 hours, or if you notice their ribs pulling in when they breathe, you need to bring them straight back."


## Gastroenteritis
Explaining Oral Rehydration Therapy (ORT), warning against fruit juices, and safety netting for dehydration (sunken fontanelle, no tears, lethargy).


## Febrile Convulsions
Reassuring a parent that it is not epilepsy, does not cause brain damage, and explaining first aid for if it happens again.
...
## Asthma
Explaining the diagnosis to a parent and teaching **inhaler technique** with a spacer
...
12. If used steroid inhaler rinse mouth with water/brush teeth to reduce change of side effect
...
- **B**ack: Always place the baby on their back for every sleep.
- **C**lear: Keep the cot free of pillows, toys, loose blankets, and bumpers.
- **Room Sharing:** Keep the baby in the same room as parents for the first six months.
- **Surface:** Use a firm, flat, waterproof mattress.
...
- Double voiding right before bed 
- Treat constipation as can worsen enuresis 
- Define desired behaviour clearly in positive terms, not necessarily related to the event. E.g. star for using the toilet before bed rather than a star for a dry night. 
- Discuss the need for clear and consistent boundaries
- Stars cannot be lost 
- Agree on value of stars beforehand