...
- BMI >35
- Family history of thromboembolic disease in first degree relatives < 45
- Controlled hypertension
- Immobility
- Carrier of BRCA1/2
- Current gallbaldder disease

UKEMC 4 conditions:
- 35+ smoking 15+ a day
- Migraine with aura
- History of thromboembolic event/thrombogenic mutation
...
- Multiphasic pills - contain varying amounts of hormone to match the normal hormonal changes more closely. 

The NICE Clinical Knowledge Summaries (2020) recommend using a pill with **_levonorgestrel_** or **_norethisterone_** first line (e.g. Microgynon or Leostrin). These choices have a lower risk of **_venous thromboembolism_**.


#### Regimes

The regimes are equally safe and effective: 
...
The best way to understand the rules is to consider that _theoretically_ women will be protected if they perfectly take the pill in a cycle of 7 days on, 7 days off. This will prevent ovulation.
...
- **Take the last pill** even if it means taking two pills in one day and then continue as normal. Leave any earlier missed pills
- The woman should use condoms or abstain from sex until she has taken pills for **7 days in a row**

| When in the cycle are pills missed | Solution                                                                                                                       |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
