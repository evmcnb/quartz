...
90% are carcinomas. The histological types of lung cancer can be broadly divided into:

- **_Small-cell lung cancer_** (**_SCLC_**) (around 20%)
- **_Non-small-cell lung cancer_** (around 80%)

**_Non-small-cell lung cancer_** can be further divided into:
- **_Adenocarcinoma_** (around 40% of total lung cancers) 
- **_Squamous cell carcinoma_** (around 20% of total lung cancers)
- **_Large-cell carcinoma_** (around 10% of total lung cancers)
...
SCLC may be responsible for various [[Pearls/Paraneoplastic Syndromes|Paraneoplastic Syndromes]]. Don't produce keratin or mucin
...
> - Clubbing
> - Lymphadenopathy (supraclavicular or persistent abnormal nodes)
...
>
>- Two or more **_unexplained symptoms_** in patients that have never smoked
>- One or more **_unexplained symptoms_** in patients that have ever smoked or had asbestos exposure
> 
> The **_unexplained symptoms_** that the NICE guidelines list are:
>- Cough
>- Shortness of breath
>- Chest pain
>- Fatigue
...
- Recurrent laryngeal nerve palsy - tumour compression $\rightarrow$ horse voice
- Phrenic nerve palsy  - tumour compression $\rightarrow$ diaphragm weakness $\rightarrow$ SoB
- [[Pearls/SVC Obstruction|SVC Obstruction]]
- **_Pancoast tumour_** (tumour in the **_pulmonary apex_**) pressing on sympathetic ganglion $\rightarrow$ [[Full/Horner's Syndrome|Horner's Syndrome]]
- Ectopic ADH from SCLC $\rightarrow$ [[Pearls/Paraneoplastic Syndromes|SIADH]]
- Ectopic ACTH from SCLC $\rightarrow$ [[Pearls/Cushing's Syndrome|Cushing's Syndrome]]
- Ectopic parathyroid hormone from SCLC $\rightarrow$ [[Pearls/Hypercalcaemia|Hypercalcaemia]]