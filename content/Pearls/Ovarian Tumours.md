...
Epithelial cell tumours (tumours arising from the **_epithelial cells_** of the ovary) are the most common type. Subtypes of epithelial cell tumours include:
...
These are benign tumours - teratomas.
- May contain various tissue types 
- Particularly associated with ovarian torsion
- May cause raised $\alpha$-FP and hCG

##### Sex Cord-Stromal Tumours
- Rare
- Can be benign or malignant 
- Arise from stroma (connective tissue) or sex cords (embryonic structure)
- Several types including Sertoli-Leydig cell tumours and granulosa cell tumours

#### Secondary Tumours

Ovarian tumours may be due to metastasis from cancer elsewhere; 
- Krukenberg tumours refers to metastasis in the ovary from the GI tract cancer - particularly the stomach
- They have a characteristic signet ring cells on histology
...
Often with non-specific symptoms. In older women, keep the threshold for investigating ovarian cancer low. Symptoms of ovarian cancer include:
- Abdominal bloating
