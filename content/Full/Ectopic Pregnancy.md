...
Have a low threshold for suspecting an ectopic pregnancy, even in atypical presentations. The classic features of an ectopic pregnancy include:
- Missed period
...
- An empty uterus
- Fluid in the uterus, which may be mistaken as a gestational sac (“**_pseudogestational_** **sac**”)

### Pregnancy of Unknown Location

Positive pregnancy test but without any evidence on ultrasound. Ectopic pregnancy cannot be excluded. 
- Serum hCG can be monitored over time (repeat every 48 hours). In an intrauterine pregnancy hCG will double every 48 hours. This is not the case for a miscarriage or ectopic. 
...
- A **fall** of **more than 50%** is likely to indicate a miscarriage. A **_urine pregnancy test_** should be performed after 2 weeks to confirm the miscarriage is complete.

## Management

Women with pelvic pain or tenderness and a positive pregnancy test need to be referred to an **_early pregnancy assessment unit_** (**_EPAU_**) or gynaecology service.
...
- **_Expectant management_** (awaiting natural termination)
