...
| --- | --- |
| **Mechanism** | Attach to penicillin binding proteins to interrupt **cell wall synthesis** |
| **Typical Dose** | 250-500mg QDS |
| **Indications** | Infection due to gram +ve/-ve bacteria (one type of surgical prophylaxis) |
| **Contra-indications** | Cephalosporin hypersensitivity |
| **Side-effects** | Diarrhoea, abx-asscoaited colitis, N&V, abdo discomfort |
