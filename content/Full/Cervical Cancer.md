...
**_Increased risk of catching HPV_** occurs with:
- Early sexual activity
- Increased number of sexual partners
- Sexual partners who have had more partners
- Not using condoms

**_Other risk factors_** are:
- **_Smoking_**
- **_HIV_** (patients with HIV are offered yearly smear tests)
- **_Combined contraceptive pill_** use for more than five years
- Increased number of **_full-term pregnancies_**
- **_Family history_**
- Exposure to **_diethylstilbestrol_** during fetal development (this was previously used to prevent miscarriages before 1971)
## Symptoms

- Abnormal vaginal bleeding (**_intermenstrual_**, **_postcoital_** or **_post-menopausal bleeding_**)
- Vaginal discharge
- Pelvic pain
...
Abnormal appearance of the cervix on speculum should be indication for **urgent referral for coposcopy**: 
- Ulceration
- Inflammation
- Bleeding
- Visible tumour
...
- **_CIN I_**: mild dysplasia, affecting 1/3 the thickness of the epithelial layer, likely to return to normal without treatment
- **_CIN II_**: moderate dysplasia, affecting 2/3 the thickness of the epithelial layer, likely to progress to cancer if untreated
- **_CIN III_**: severe dysplasia, very likely to progress to cancer if untreated

CIN III is sometimes called **_cervical carcinoma in situ_**.
...
- **_Stage 1B – 2A_**: Radical hysterectomy and removal of local lymph nodes with chemotherapy and radiotherapy
