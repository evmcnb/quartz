...
***Medical emergency*** but rare. Extensive erythematous extensor inflammation. The skin may come away in large patches, resulting in raw exposed areas. Patients require admission.
...
- **_Auspitz sign_** refers to small points of bleeding when plaques are scraped off
- **_Koebner phenomenon_** refers to the development of psoriatic lesions to areas of skin affected by trauma
- **_Residual pigmentation_** of the skin after the lesions resolve
...
There are two products that contain both a potent steroid and vitamin D analogue that are commonly prescribed. These not licensed in children and will be guided by a specialist.
- **_Dovobet_**
- **_Enstilar_**
