...
**Reposition the patient to lying at 45$\degree$ on the bed**
...
### Thomas's test
Should **not** be performed on patients with a hip replacement 
Used to assess for fixed flexion deformity
...
3. Repeat with the other limb
The test is positive if the affected thigh raises off the bed indicating a fixed flexion deformity
