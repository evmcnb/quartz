...
![[z_attachments/Pasted image 20250227120741.png|400]]
...
**Parkland formula:** 
The fluid requirements for burns patients in a 24 hour period in mL. For fluids within the first 8 hours, half the value. 
$$
4 \times \text{burned body surface area (\%)} \times \text{weight (kg)} = \text{Fluid requirements in 24hrs }(mL)
$$