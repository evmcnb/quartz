...
Aortic dissection refers to when a break or tear forms in the inner layer of the aorta, allowing blood to flow between the layers of the wall of the aorta. There are three layers to the aorta, the **_intima_**, **_media_** and **_adventitia_**
...
- ECG & CXR to exclude MI & other causes.
- Full set of bloods to see if any end-organ damage. 
## Management

**Initial**:
IV labetalol to lower blood pressure and HR to reduce pressure on the walls 

**Definitive:**
- Type A - open surgery for a graft replacement
- Type B - endovascular stent graft. Complicated cases may require surgery. 

Dissection and MI can occur together but treating an MI with thrombolysis can cause a fatal progression of the dissection. 
