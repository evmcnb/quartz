...
| --- | --- |
| **Mechanism** | Weak inhibitor of COX  Don't really know otherwise |
| **Typical Dose** | 1g up to 4 times a day |
| **Indications** | * Mild moderate pain * Pyrexia |
| **Contra-indications** | Caution in chronic alcohol abuse |
| **Side-effects** | Most common poisoning agent - hepatic necrosis, N-acetylcysteine antidote |
| **Interactions** | Nothing particularly |
| **Elimination** |  |
| **Additional Notes** | Commonly used in children as not associated with Reye's disease (unlike aspirin). Does not cause GI irritability either |
