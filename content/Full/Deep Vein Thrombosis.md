...
- DVT is likely (Wells ≥ 2) AND ultrasound is delayed (**can’t be done within 4 hours**)  
- DVT is confirmed by ultrasound  
- DVT is unlikely (Wells ≤ 1) but D-dimer result is delayed  

Do not start a DOAC immediately if:  
- DVT is unlikely and D-dimer is negative  
- DVT is likely, ultrasound is available within **4 hours**, and you're waiting for result  
  
Stop DOAC if it was started as interim treatment (before confirmation), and:  
- Ultrasound is negative and D-dimer is negative → Stop anticoagulation  
- Ultrasound is negative but D-dimer is positive → Stop anticoagulation, but repeat scan in 6–8 days

If patient has any of the following, use LMWH + warfarin instead: 
- [[Pearls/Antiphospholipid syndrome|Antiphospholipid syndrome]] (triple positive)
- Severe renal impairment (eGFR <15)

Note that patients with active cancer now are recommended DOACs
